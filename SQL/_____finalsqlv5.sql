...
CREATE TABLE StudentOption(
    ...
    OptionName NVARCHAR(255),
    StudentID INT,
	PRIMARY KEY(QuestionID,OptionName,StudentID),
    FOREIGN KEY (QuestionID, OptionName) REFERENCES Options(QuestionID, OptionName),
    FOREIGN KEY (StudentID) REFERENCES Student(StudentID)
);
GO
...
EXEC InsertCoupon 'Mã giảm giá 1', 10, 'percent', '2024-01-01', '2024-12-31', 100, @ErrorMessage OUTPUT

EXEC UpdateCoupon '1', 'Mã giảm giá 2', 20, 'percent', '2024-01-01', '2024-12-31', 200, @ErrorMessage OUTPUT
...
(1, 'A', N'Một framework JavaScript', 0),
(1, 'B', N'Một thư viện JavaScript để xây dựng giao diện người dùng', 1),
(1, 'C', N'Một ngôn ngữ lập trình', 0),
(1, 'D', N'Một cơ sở dữ liệu', 0),

-- Options for Question 2 (JSX trong React là gì?)
(2, 'A', N'Một extension của JavaScript cho phép viết HTML trong JavaScript', 1),
(2, 'B', N'Một ngôn ngữ lập trình mới', 0),
(2, 'C', N'Một framework', 0),
(2, 'D', N'Một thư viện độc lập', 0),

-- Options for Question 3 (Props trong React)
(3, 'A', N'Để lưu trữ state của component', 0),
(3, 'B', N'Để truyền dữ liệu giữa các component', 1),
(3, 'C', N'Để tạo routing', 0),
(3, 'D', N'Để kết nối database', 0),

-- Options for Question 4 (State trong React)
(4, 'A', N'Dữ liệu tĩnh không thay đổi', 0),
(4, 'B', N'Dữ liệu động có thể thay đổi trong component', 1),
(4, 'C', N'Thuộc tính CSS', 0),
(4, 'D', N'Tên component', 0),
...
(6, 'A', N'IDE chính thức để phát triển ứng dụng Android', 1),
(6, 'B', N'Một trình duyệt web', 0),
(6, 'C', N'Một hệ điều hành', 0),
(6, 'D', N'Một ngôn ngữ lập trình', 0),

-- Options for Question 7 (Layout trong Android là gì?)
(7, 'A', N'Một dạng cơ sở dữ liệu', 0),
(7, 'B', N'Cấu trúc sắp xếp các thành phần giao diện người dùng', 1),
(7, 'C', N'Một kiểu biến trong Android', 0),
(7, 'D', N'Một công cụ debug', 0),

-- Options for Question 8 (Activity trong Android là gì?)
(8, 'A', N'Một file cấu hình', 0),
(8, 'B', N'Một component đại diện cho một màn hình trong ứng dụng', 1),
(8, 'C', N'Một thư viện đồ họa', 0),
(8, 'D', N'Một loại database', 0),

-- Options for Question 9 (Intent trong Android)
(9, 'A', N'Một cơ chế để chuyển đổi giữa các Activity', 1),
(9, 'B', N'Một kiểu dữ liệu', 0),
(9, 'C', N'Một framework testing', 0),
(9, 'D', N'Một công cụ build', 0),

-- Options for Question 10 (SQLite trong Android)
(10, 'A', N'Một framework UI', 0),
(10, 'B', N'Một hệ quản trị cơ sở dữ liệu nhẹ tích hợp trong Android', 1),
(10, 'C', N'Một công cụ debug', 0),
(10, 'D', N'Một thư viện đồ họa', 0),

-- Options for Question 11 (Primary Key là gì?)
(11, 'A', N'Khóa dùng để mở database', 0),
(11, 'B', N'Trường duy nhất định danh cho mỗi bản ghi trong bảng', 1),
(11, 'C', N'Một loại index', 0),
(11, 'D', N'Một công cụ tối ưu', 0),

-- Options for Question 12 (JOIN trong SQL là gì?)
(12, 'A', N'Lệnh để tạo bảng mới', 0),
(12, 'B', N'Phương thức kết hợp dữ liệu từ nhiều bảng', 1),
(12, 'C', N'Công cụ backup database', 0),
(12, 'D', N'Một loại constraint', 0),

-- Options for Question 13 (Stored Procedure là gì?)
(13, 'A', N'Một tập hợp các câu lệnh SQL được biên dịch sẵn', 1),
(13, 'B', N'Một loại table', 0),
(13, 'C', N'Một công cụ quản lý user', 0),
(13, 'D', N'Một kiểu dữ liệu', 0),

-- Options for Question 14 (Transaction trong SQL Server)
(14, 'A', N'Một công cụ backup', 0),
(14, 'B', N'Một đơn vị công việc đảm bảo tính toàn vẹn dữ liệu', 1),
(14, 'C', N'Một loại index', 0),
(14, 'D', N'Một kiểu join', 0),

-- Options for Question 15 (Index trong SQL Server)
(15, 'A', N'Một cấu trúc để tối ưu hóa truy vấn', 1),
(15, 'B', N'Một loại bảng', 0),
(15, 'C', N'Một công cụ backup', 0),
(15, 'D', N'Một kiểu constraint', 0),

-- Options for Question 16 (Machine Learning là gì?)
(16, 'A', N'Một ngôn ngữ lập trình', 0),
(16, 'B', N'Khả năng máy tính học từ dữ liệu mà không cần lập trình tường minh', 1),
(16, 'C', N'Một hệ điều hành', 0),
(16, 'D', N'Một công cụ phần mềm', 0),

-- Options for Question 17 (Supervised Learning là gì?)
(17, 'A', N'Học có giám sát với dữ liệu được gán nhãn', 1),
(17, 'B', N'Học không giám sát', 0),
(17, 'C', N'Học tăng cường', 0),
(17, 'D', N'Deep Learning', 0),

-- Options for Question 18 (Unsupervised Learning là gì?)
(18, 'A', N'Học có giám sát', 0),
(18, 'B', N'Học không giám sát với dữ liệu không gán nhãn', 1),
(18, 'C', N'Học tăng cường', 0),
(18, 'D', N'Transfer Learning', 0),

-- Options for Question 19 (Deep Learning là gì?)
(19, 'A', N'Một thuật toán Machine Learning', 0),
(19, 'B', N'Một phương pháp học sâu sử dụng nhiều lớp neural network', 1),
(19, 'C', N'Một công cụ phần mềm', 0),
(19, 'D', N'Một ngôn ngữ lập trình', 0),

-- Options for Question 20 (Neural Network là gì?)
(20, 'A', N'Một thuật toán đơn giản', 0),
(20, 'B', N'Một mô hình học máy lấy cảm hứng từ não người', 1),
(20, 'C', N'Một cơ sở dữ liệu', 0),
(20, 'D', N'Một công cụ lập trình', 0);
...
VALUES
(7, 1, 1, N'Chương 1: Giới thiệu về ReactJS', 0), --học sinh 7 làm bài kiểm tra số 1 cu
...
-- Sinh viên 7 làm 3 bài kiểm tra

-- Học sinh 7 làm bài kiểm tra số 1 chương 1 của khóa học React (CourseID = 1)
INSERT INTO StudentOption (QuestionID, OptionName, StudentID) VALUES
-- Trả lời 5 câu hỏi của bài test 1 chương 1
(1, 'A', 7),  -- Câu 1: chọn A
(2, 'B', 7),  -- Câu 2: chọn B
(3, 'C', 7),  -- Câu 3: chọn C
(4, 'A', 7),  -- Câu 4: chọn A
...
-- Học sinh 7 làm bài kiểm tra số 2 chương 1 của khóa học React
INSERT INTO StudentOption (QuestionID, OptionName, StudentID) VALUES
-- Trả lời 5 câu hỏi của bài test 2 chương 1
(6, 'B', 7),   -- Câu 6: chọn B
(7, 'C', 7),   -- Câu 7: chọn C
(8, 'A', 7),   -- Câu 8: chọn A
(9, 'B', 7),   -- Câu 9: chọn B
(10, 'A', 7);  -- Câu 10: chọn A

-- Học sinh 8 làm bài kiểm tra số 1 chương 1 của khóa học React
INSERT INTO StudentOption (QuestionID, OptionName, StudentID) VALUES
-- Trả lời 5 câu hỏi của bài test 1 chương 1
(1, 'B', 8),  -- Câu 1: chọn B
(2, 'A', 8),  -- Câu 2: chọn A
...
-- Học sinh 8 làm bài kiểm tra số 2 chương 1 của khóa học SQL (CourseID = 3)
INSERT INTO StudentOption (QuestionID, OptionName, StudentID) VALUES
-- Trả lời 5 câu hỏi của bài test 2 chương 1
(11, 'A', 8),  -- Câu 11: chọn A
(12, 'B', 8),  -- Câu 12: chọn B
(13, 'C', 8),  -- Câu 13: chọn C
(14, 'A', 8),  -- Câu 14: chọn A
(15, 'B', 8);  -- Câu 15: chọn B

-- Học sinh 9 làm bài kiểm tra số 1 chương 1 của khóa học Android (CourseID = 2)
INSERT INTO StudentOption (QuestionID, OptionName, StudentID) VALUES
-- Trả lời 5 câu hỏi của bài test 1 chương 1
(16, 'B', 9),  -- Câu 16: chọn B
(17, 'C', 9),  -- Câu 17: chọn C
(18, 'A', 9),  -- Câu 18: chọn A
(19, 'B', 9),  -- Câu 19: chọn B
(20, 'C', 9);  -- Câu 20: chọn C

-- Học sinh 10 làm bài kiểm tra số 1 chương 1 của khóa học SQL (CourseID = 3)
INSERT INTO StudentOption (QuestionID, OptionName, StudentID) VALUES
-- Trả lời 5 câu hỏi của bài test 1 chương 1
(1, 'A', 10),  -- Câu 1: chọn A
(2, 'B', 10),  -- Câu 2: chọn B
...
SELECT * FROM Student
GO
CREATE OR ALTER FUNCTION CalculateStudentTestScore
(
    @StudentID INT
)
RETURNS FLOAT
...
BEGIN
    ...
    DECLARE @CurrentTestOrder INT;
    DECLARE @CurrentCourseID INT;
    DECLARE @CurrentChapterName NVARCHAR(255);
    DECLARE @QuestionCount INT;
    DECLARE @PointsPerQuestion FLOAT;
    ...
    IF NOT EXISTS (SELECT 1 FROM Student WHERE StudentID = @StudentID)
        ...
        RETURN -1; -- Invalid StudentID


    -- Cursor to iterate through all tests taken by the student
    ...
    OPEN TestCursor;
    FETCH NEXT FROM TestCursor INTO @CurrentTestOrder, @CurrentCourseID, @CurrentChapterName;
    ...
    BEGIN
        ...
        WHERE qt.TestOrder = @CurrentTestOrder
        AND qt.CourseID = @CurrentCourseID
        AND qt.ChapterName = @CurrentChapterName;

        -- Calculate points per question (10 points total per test)
        SET @PointsPerQuestion = 10.0 / @QuestionCount;

        -- Count correct answers for this test
        SELECT @CorrectAnswers = COUNT(*)
        FROM StudentOption so
        JOIN Options o ON so.QuestionID = o.QuestionID AND so.OptionName = o.OptionName
        JOIN QuestionTest qt ON qt.QuestionID = o.QuestionID
        WHERE so.StudentID = @StudentID
        AND qt.TestOrder = @CurrentTestOrder
        AND qt.CourseID = @CurrentCourseID
        AND qt.ChapterName = @CurrentChapterName
        AND o.IsCorrect = 1;

        -- Calculate score for this test
        SET @TestScore = @CorrectAnswers * @PointsPerQuestion;
    ...
    RETURN CASE
        ...
        WHEN @TestCount > 0 THEN @TotalScore / @TestCount
...
SET @AvgScore = dbo.CalculateStudentTestScore(100); -- Tính điểm trung bình của học sinh có StudentID = 8
